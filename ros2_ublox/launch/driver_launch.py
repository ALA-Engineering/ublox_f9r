...
def generate_launch_description():
    share_dir = get_package_share_directory('ros2_ublox')
    parameter_file = LaunchConfiguration('params_file')
    node_name = 'ublox_driver'
    ...
    driver_node = LifecycleNode(package='ros2_ublox',
    ...
    activate_event = RegisterEventHandler(
        OnStateTransition(
            ...
            entities=[
                LogInfo(
                    msg="[LifecycleLaunch] ublox driver node is activating."),
    ...
    shutdown_event = RegisterEventHandler(
        OnShutdown(
            on_shutdown=[
                ...
                LogInfo(
                    msg="[LifecycleLaunch] ublox driver node is exiting."),
            ],
        )
    )
